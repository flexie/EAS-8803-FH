...
- more advanced wave-equation based imaging, inversion, and inversion techniques

We will also explore alternative usage of active-source reflection seismology in areas relevant to the energy transition. 
...
- [Wave-equatiob based imaging & inversion (RTM & FWI)](outline.qmd#sec-RTM)

- Wave-equation based inference w/ uncertainty quantification
...
- [Hill, Stephen, and Andreas Rüger. "Illustrated Seismic Processing." Imaging (2019).](https://pubs.geoscienceworld.org/seg/books/edited-volume/2532/Illustrated-Seismic-Processing-Volume-1-Imaging)

- [Scales, John. "Theory of Seismic Imaging"](https://samizdat.mines.edu/theory-of-seismic-imaging-by-john-scales/) 
...
During the term, additional material will be made available under the tab [Schedule](schedule.qmd).

[^1]: Some of these texts are available when on campus or from the Library.
...
The lectures and computational assignments will be posted under [Schedule](schedule.qmd). Further details on the computational assignments see [Assignments](assignments.qmd) and [Final Project](project.qmd).

In part, this course is an adaptation of course material developed by Dr. Eric Verschuur and Dr. Guy Drijkoningen from the Delft Technical University and [Dr. Ravasi](https://github.com/DIG-Kaust/Seismology) formally at KAUST.
...
There will be no exam. There will be a [Final project](project.qmd).
