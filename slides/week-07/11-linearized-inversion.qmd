...
<!-- - **Evanescent waves** — non-propagating near-field contributions -->
:::
...
![](figures_lin/seismic-inversion-intuitive.png){fig-align="center" width="55%"}
...
<!-- ![](figures_lin/marlin-field-impedance.png){fig-align="center" width="100%"} -->
![](figures_lin/marlin.png){fig-align="center" width="100%"}
...
## Bulk and Shear Modulus, P- and S-Wave Speeds {.smaller}
...
![](figures_lin/p-wave-particle-motion.png){fig-align="center" width="85%"}
...
![](figures_lin/s-wave-particle-motion.png){fig-align="center" width="85%"}
...
![Adapted from Eric Verschuur](figures_lin/snell.png)
...
![](figures_lin/smooth-background-velocity-profile.jpeg){fig-align="center" width="55%"}

::: aside
Smooth inhomogeneous background (red) eliminates ~95% of kinematic inaccuracy compared to the true velocity (blue).
:::
...
## Structure of the Linearized $R_{PP}$ {.smaller}
...
:::: {.columns}
::: {.column width="50%"}
![](figures_lin/radon-transform-xt.png){fig-align="center" width="95%"}
:::
::: {.column width="50%"}
![](figures_lin/radon-transform-taup.png){fig-align="center" width="95%"}
:::
::::
...
![](figures_lin/focused-reflection-xt.png){fig-align="center" width="95%"}

:::
::: {.column width="50%"}

![](figures_lin/focused-radon-amplitudes.png){fig-align="center" width="95%"}
...
![](figures_lin/spectral-gap.jpeg){fig-align="center" width="95%"}
...
![](figures_lin/synthetic-1d-model.jpeg){fig-align="center" width="95%"}
...
## Band-Limited vs. Broadband Inversion Results {.smaller}
...
![](figures_lin/predicted-vs-actual-bandlimited.jpeg){fig-align="center" width="95%"}
...
![](figures_lin/predicted-vs-actual-broadband.jpeg){fig-align="center" width="95%"}
...
![](figures_lin/low-contrast-model.jpeg){fig-align="center" width="95%"}
...
![](figures_lin/low-contrast-radon.jpeg){fig-align="center" width="95%"}
...
![](figures_lin/low-contrast-inversion-bandlimited.jpeg){fig-align="center" width="95%"}
...
![](figures_lin/low-contrast-inversion-broadband.jpeg){fig-align="center" width="95%"}
...
![](figures_lin/real-data-shot-stacked.jpeg){fig-align="center" width="95%"}
...
![](figures_lin/real-data-inversion-results.png){fig-align="center" width="95%"}
